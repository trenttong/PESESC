...
//#define PRINT_CLOCKTICKS	// ATTA: uncomment this flag to print the clock ticks for the main core.
							// ATTA: comment this flag to print the total number of instructions
#ifndef PRINT_CLOCKTICKS
...
class DInst {
public: //private:		// ATTA: variables are public for debugging
#ifdef ESESC_FUZE
...
public:
  ...
  void setHitLevel(MemObj* hitMemObj) {
	  hitLevel = hitMemObj;
  }
  MemObj* getHitLevel() { return hitLevel; }
#endif // DELINQUENT_LOAD
