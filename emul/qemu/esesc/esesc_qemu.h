...
void QEMUReader_queue_inst(uint32_t insn,  /// instruction bytes.
                           uint32_t pc,    /// pc.
                           ...
                           uint32_t rmn,   /// RM num
                           uint32_t rsn,   /// RS num
                           uint32_t dfn,   /// default num
                           uint32_t rdv,   /// RD value
                           uint32_t rnv,   /// RN value
                           uint32_t rmv,   /// RM value
                           uint32_t rsv,   /// RS value
                           uint32_t dfv,   /// default value
